...
- [x] Portfolio-Watch-Skill 的 `AGENTS.md` 记录了存储/部署的实战坑，DEV-PLAN 阶段必读。→ 已落实（2026-07-12）：Phase 5 `seed.portfolioWatch` 按 config/profile/watch/feed/UDF/notify/release 实战链路实现，见 `DEV-PLAN.md` §7。
